...
Every failure inside arxivist raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`arxivist.cli._output`,
...
# Exit-code policy. Documented in ``arxivist learn`` output.
# 0      = success
